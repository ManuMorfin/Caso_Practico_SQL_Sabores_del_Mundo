...
limit 5
 ...
 -- El último pedido fue el 2023-03-31 y el primer pedido fue el 2023-01-01
...
WHERE order_date >= '2023-01-01' and order_date <= '2023-01-05' ;
 ...
 -- cual es el top 5 de pedidos mexicana mas vendidos 
 ...
 limit 5
 -- cual es la suma de precios por categoria?
